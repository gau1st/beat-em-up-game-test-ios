...
-(id)init {
    if ((self = [super initWithSpriteFrameName:@"hero_idle_00.png"])) {
        ...
        self.attackBox = [self createBoundingBoxWithOrigin:ccp(self.centerToSides, -5) size:CGSizeMake(20, 20)];
...
-(void)knockout {
    [super knockout];
    [[SimpleAudioEngine sharedEngine] playEffect:@"pd_botdeath.mp3"];
}
